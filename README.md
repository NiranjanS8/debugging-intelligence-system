...
- Markdown is the primary artifact, so secondary stores are projections rather than the source of truth.
- The projection queue improves consistency, but this is not a full distributed transaction system.
- Hybrid retrieval is lightweight and pragmatic rather than a full BM25/search-engine stack.
- Neo4j is optional to keep local development simple.

---

## Resume Angle

This project is a solid applied-AI/backend systems project because it combines:
...
- projection-queue-based multi-store consistency

---

## License

Add a license section here if you plan to publish the project publicly.
